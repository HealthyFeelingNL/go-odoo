...
type CrmTeam struct {
	AbandonedCartsAmount         *Int        `xmlrpc:"abandoned_carts_amount,omptempty"`
	AbandonedCartsCount          *Int        `xmlrpc:"abandoned_carts_count,omptempty"`
	...
	AliasEmail                   *String     `xmlrpc:"alias_email,omptempty"`
	AliasForceThreadId           *Int        `xmlrpc:"alias_force_thread_id,omptempty"`
	AliasFullName                *String     `xmlrpc:"alias_full_name,omptempty"`
	AliasId                      *Many2One   `xmlrpc:"alias_id,omptempty"`
	AliasIncomingLocal           *Bool       `xmlrpc:"alias_incoming_local,omptempty"`
	...
	AliasStatus                  *Selection  `xmlrpc:"alias_status,omptempty"`
	AssignmentAutoEnabled        *Bool       `xmlrpc:"assignment_auto_enabled,omptempty"`
	...
	CrmTeamMemberAllIds          *Relation   `xmlrpc:"crm_team_member_all_ids,omptempty"`
	...
	Invoiced                     *Float      `xmlrpc:"invoiced,omptempty"`
	InvoicedTarget               *Float      `xmlrpc:"invoiced_target,omptempty"`
	IsFavorite                   *Bool       `xmlrpc:"is_favorite,omptempty"`
	IsMembershipMulti            *Bool       `xmlrpc:"is_membership_multi,omptempty"`
	LeadAllAssignedMonthCount    *Int        `xmlrpc:"lead_all_assigned_month_count,omptempty"`
	LeadAllAssignedMonthExceeded *Bool       `xmlrpc:"lead_all_assigned_month_exceeded,omptempty"`
	LeadPropertiesDefinition     interface{} `xmlrpc:"lead_properties_definition,omptempty"`
	LeadUnassignedCount          *Int        `xmlrpc:"lead_unassigned_count,omptempty"`
	MemberCompanyIds             *Relation   `xmlrpc:"member_company_ids,omptempty"`
	...
	OpportunitiesAmount          *Float      `xmlrpc:"opportunities_amount,omptempty"`
	OpportunitiesCount           *Int        `xmlrpc:"opportunities_count,omptempty"`
	OpportunitiesOverdueAmount   *Float      `xmlrpc:"opportunities_overdue_amount,omptempty"`
	OpportunitiesOverdueCount    *Int        `xmlrpc:"opportunities_overdue_count,omptempty"`
	QuotationsAmount             *Float      `xmlrpc:"quotations_amount,omptempty"`
