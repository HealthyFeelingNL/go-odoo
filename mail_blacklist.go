...
type MailBlacklist struct {
	...
	OptOutReasonId           *Many2One `xmlrpc:"opt_out_reason_id,omptempty"`
...
func (c *Client) CreateMailBlacklists(mbs []*MailBlacklist) ([]int64, error) {
	...
	return c.Create(MailBlacklistModel, vv)
}
...
func (c *Client) FindMailBlacklist(criteria *Criteria) (*MailBlacklist, error) {
	...
	return nil, fmt.Errorf("mail.blacklist was not found with criteria %v", criteria)
}
...
func (c *Client) FindMailBlacklistId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("mail.blacklist was not found with criteria %v and options %v", criteria, options)
}
