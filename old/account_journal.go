...
type AccountJournal struct {
	...
	AliasAutoExtractPdfsOnly        *Bool      `xmlrpc:"alias_auto_extract_pdfs_only,omptempty"`
	...
	CurrentStatementBalance         *Float     `xmlrpc:"current_statement_balance,omptempty"`
	DebitSepaPainVersion            *Selection `xmlrpc:"debit_sepa_pain_version,omptempty"`
	...
	DisplayAliasAutoExtractPdfsOnly *Bool      `xmlrpc:"display_alias_auto_extract_pdfs_only,omptempty"`
	...
	HasStatementLines               *Bool      `xmlrpc:"has_statement_lines,omptempty"`
	...
	LastStatementId                 *Many2One  `xmlrpc:"last_statement_id,omptempty"`
