...
type AccountReport struct {
	...
	FilterAccountType        *Selection `xmlrpc:"filter_account_type,omptempty"`
	FilterAmlIrFilters       *Bool      `xmlrpc:"filter_aml_ir_filters,omptempty"`
	...
	FilterHide0Lines         *Selection `xmlrpc:"filter_hide_0_lines,omptempty"`
	...
	PrefixGroupsThreshold    *Int       `xmlrpc:"prefix_groups_threshold,omptempty"`
	RootReportId             *Many2One  `xmlrpc:"root_report_id,omptempty"`
	SearchBar                *Bool      `xmlrpc:"search_bar,omptempty"`
	SectionMainReportIds     *Relation  `xmlrpc:"section_main_report_ids,omptempty"`
	SectionReportIds         *Relation  `xmlrpc:"section_report_ids,omptempty"`
	Sequence                 *Int       `xmlrpc:"sequence,omptempty"`
	UseSections              *Bool      `xmlrpc:"use_sections,omptempty"`
...
func (c *Client) CreateAccountReports(ars []*AccountReport) ([]int64, error) {
	...
	return c.Create(AccountReportModel, vv)
}
