...
type AccountTax struct {
	...
	InvoiceLabel                 *String    `xmlrpc:"invoice_label,omptempty"`
	InvoiceRepartitionLineIds    *Relation  `xmlrpc:"invoice_repartition_line_ids,omptempty"`
	IsBaseAffected               *Bool      `xmlrpc:"is_base_affected,omptempty"`
	IsUsed                       *Bool      `xmlrpc:"is_used,omptempty"`
	...
	NameSearchable               *String    `xmlrpc:"name_searchable,omptempty"`
	...
	RepartitionLineIds           *Relation  `xmlrpc:"repartition_line_ids,omptempty"`
	RepartitionLinesStr          *String    `xmlrpc:"repartition_lines_str,omptempty"`
	Sequence                     *Int       `xmlrpc:"sequence,omptempty"`
	TaxExigibility               *Selection `xmlrpc:"tax_exigibility,omptempty"`
	TaxGroupId                   *Many2One  `xmlrpc:"tax_group_id,omptempty"`
	TaxScope                     *Selection `xmlrpc:"tax_scope,omptempty"`
...
func (c *Client) CreateAccountTaxs(ats []*AccountTax) ([]int64, error) {
	...
	return c.Create(AccountTaxModel, vv)
}
