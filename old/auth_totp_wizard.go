...
type AuthTotpWizard struct {
	...
	Qrcode      *String   `xmlrpc:"qrcode,omptempty"`
	Secret      *String   `xmlrpc:"secret,omptempty"`
...
func (c *Client) CreateAuthTotpWizards(aws []*AuthTotpWizard) ([]int64, error) {
	...
	return c.Create(AuthTotpWizardModel, vv)
}
...
func (c *Client) FindAuthTotpWizard(criteria *Criteria) (*AuthTotpWizard, error) {
	...
	return nil, fmt.Errorf("auth_totp.wizard was not found with criteria %v", criteria)
}
...
func (c *Client) FindAuthTotpWizardId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("auth_totp.wizard was not found with criteria %v and options %v", criteria, options)
}
