...
type CrmLead struct {
	...
	DateAutomationLast              *Time       `xmlrpc:"date_automation_last,omptempty"`
	...
	EmailDomainCriterion            *String     `xmlrpc:"email_domain_criterion,omptempty"`
	...
	IapEnrichDone                   *Bool       `xmlrpc:"iap_enrich_done,omptempty"`
	...
	LeadMiningRequestId             *Many2One   `xmlrpc:"lead_mining_request_id,omptempty"`
	...
	MeetingDisplayLabel             *String     `xmlrpc:"meeting_display_label,omptempty"`
	...
	RecurringRevenueProrated        *Float      `xmlrpc:"recurring_revenue_prorated,omptempty"`
	...
	ShowEnrichButton                *Bool       `xmlrpc:"show_enrich_button,omptempty"`
