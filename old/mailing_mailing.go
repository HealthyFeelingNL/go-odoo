...
type MailingMailing struct {
	...
	AbTestingIsWinnerMailing    *Bool      `xmlrpc:"ab_testing_is_winner_mailing,omptempty"`
	AbTestingMailingsCount      *Int       `xmlrpc:"ab_testing_mailings_count,omptempty"`
	AbTestingMailingsSmsCount   *Int       `xmlrpc:"ab_testing_mailings_sms_count,omptempty"`
	...
	AbTestingSmsWinnerSelection *Selection `xmlrpc:"ab_testing_sms_winner_selection,omptempty"`
	...
	BouncedRatio                *Float     `xmlrpc:"bounced_ratio,omptempty"`
	...
	ClicksRatio                 *Float     `xmlrpc:"clicks_ratio,omptempty"`
	...
	IsAbTestSent                *Bool      `xmlrpc:"is_ab_test_sent,omptempty"`
	...
	MailingOnMailingList        *Bool      `xmlrpc:"mailing_on_mailing_list,omptempty"`
	...
	NextDepartureIsPast         *Bool      `xmlrpc:"next_departure_is_past,omptempty"`
	Opened                      *Int       `xmlrpc:"opened,omptempty"`
	OpenedRatio                 *Float     `xmlrpc:"opened_ratio,omptempty"`
	Pending                     *Int       `xmlrpc:"pending,omptempty"`
	Preview                     *String    `xmlrpc:"preview,omptempty"`
	Process                     *Int       `xmlrpc:"process,omptempty"`
	RatingIds                   *Relation  `xmlrpc:"rating_ids,omptempty"`
	ReceivedRatio               *Float     `xmlrpc:"received_ratio,omptempty"`
	RenderModel                 *String    `xmlrpc:"render_model,omptempty"`
	Replied                     *Int       `xmlrpc:"replied,omptempty"`
	RepliedRatio                *Float     `xmlrpc:"replied_ratio,omptempty"`
	...
	SmsHasUnregisteredAccount   *Bool      `xmlrpc:"sms_has_unregistered_account,omptempty"`
	SmsSubject                  *String    `xmlrpc:"sms_subject,omptempty"`
