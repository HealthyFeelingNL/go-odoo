...
func (c *Client) CreateResUsersApikeysDescriptions(ruads []*ResUsersApikeysDescription) ([]int64, error) {
	...
	return c.Create(ResUsersApikeysDescriptionModel, vv)
}
...
func (c *Client) FindResUsersApikeysDescription(criteria *Criteria) (*ResUsersApikeysDescription, error) {
	...
	return nil, fmt.Errorf("res.users.apikeys.description was not found with criteria %v", criteria)
}
...
func (c *Client) FindResUsersApikeysDescriptionId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("res.users.apikeys.description was not found with criteria %v and options %v", criteria, options)
}
