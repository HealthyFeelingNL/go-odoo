...
type PosOrder struct {
	...
	Cashier                    *String    `xmlrpc:"cashier,omptempty"`
	...
	CustomerCount              *Int       `xmlrpc:"customer_count,omptempty"`
	...
	LastOrderPreparationChange *String    `xmlrpc:"last_order_preparation_change,omptempty"`
	...
	NextOnlinePaymentAmount    *Float     `xmlrpc:"next_online_payment_amount,omptempty"`
	Note                       *String    `xmlrpc:"note,omptempty"`
	OnlinePaymentMethodId      *Many2One  `xmlrpc:"online_payment_method_id,omptempty"`
	...
	ShippingDate               *Time      `xmlrpc:"shipping_date,omptempty"`
	State                      *Selection `xmlrpc:"state,omptempty"`
	TableId                    *Many2One  `xmlrpc:"table_id,omptempty"`
	TableStandNumber           *String    `xmlrpc:"table_stand_number,omptempty"`
	TakeAway                   *Bool      `xmlrpc:"take_away,omptempty"`
	TicketCode                 *String    `xmlrpc:"ticket_code,omptempty"`
	TipAmount                  *Float     `xmlrpc:"tip_amount,omptempty"`
	ToInvoice                  *Bool      `xmlrpc:"to_invoice,omptempty"`
	TrackingNumber             *String    `xmlrpc:"tracking_number,omptempty"`
	UseSelfOrderOnlinePayment  *Bool      `xmlrpc:"use_self_order_online_payment,omptempty"`
...
func (c *Client) CreatePosOrders(pos []*PosOrder) ([]int64, error) {
	...
	return c.Create(PosOrderModel, vv)
}
