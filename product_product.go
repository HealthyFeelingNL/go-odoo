...
type ProductProduct struct {
	...
	CountryOfOrigin                      *Many2One   `xmlrpc:"country_of_origin,omptempty"`
	CreateDate                           *Time       `xmlrpc:"create_date,omptempty"`
	CreateUid                            *Many2One   `xmlrpc:"create_uid,omptempty"`
	CurrencyId                           *Many2One   `xmlrpc:"currency_id,omptempty"`
	DefaultCode                          *String     `xmlrpc:"default_code,omptempty"`
	Description                          *String     `xmlrpc:"description,omptempty"`
	DescriptionEcommerce                 *String     `xmlrpc:"description_ecommerce,omptempty"`
	...
	LotPropertiesDefinition              interface{} `xmlrpc:"lot_properties_definition,omptempty"`
	...
	ProductCatalogProductIsInSaleOrder   *Bool       `xmlrpc:"product_catalog_product_is_in_sale_order,omptempty"`
	ProductDocumentCount                 *Int        `xmlrpc:"product_document_count,omptempty"`
	ProductDocumentIds                   *Relation   `xmlrpc:"product_document_ids,omptempty"`
	ProductProperties                    interface{} `xmlrpc:"product_properties,omptempty"`
