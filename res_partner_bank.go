...
type ResPartnerBank struct {
	...
	HasIbanWarning                  *Bool      `xmlrpc:"has_iban_warning,omptempty"`
	HasMessage                      *Bool      `xmlrpc:"has_message,omptempty"`
	HasMoneyTransferWarning         *Bool      `xmlrpc:"has_money_transfer_warning,omptempty"`
	Id                              *Int       `xmlrpc:"id,omptempty"`
	JournalId                       *Relation  `xmlrpc:"journal_id,omptempty"`
	LockTrustFields                 *Bool      `xmlrpc:"lock_trust_fields,omptempty"`
	...
	MoneyTransferService            *String    `xmlrpc:"money_transfer_service,omptempty"`
	MyActivityDateDeadline          *Time      `xmlrpc:"my_activity_date_deadline,omptempty"`
	PartnerCountryName              *String    `xmlrpc:"partner_country_name,omptempty"`
	PartnerCustomerRank             *Int       `xmlrpc:"partner_customer_rank,omptempty"`
	PartnerId                       *Many2One  `xmlrpc:"partner_id,omptempty"`
	PartnerSupplierRank             *Int       `xmlrpc:"partner_supplier_rank,omptempty"`
	RatingIds                       *Relation  `xmlrpc:"rating_ids,omptempty"`
	RelatedMoves                    *Relation  `xmlrpc:"related_moves,omptempty"`
	SanitizedAccNumber              *String    `xmlrpc:"sanitized_acc_number,omptempty"`
	Sequence                        *Int       `xmlrpc:"sequence,omptempty"`
	UserHasGroupValidateBankAccount *Bool      `xmlrpc:"user_has_group_validate_bank_account,omptempty"`
